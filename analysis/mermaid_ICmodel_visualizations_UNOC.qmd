...
## Information about data used (sources and images)

The following includes information about the public CoralNet sources and images we used to develop the MERMAID image classification model. In total, we used 519398 images from 326 public sources, representing a diverse set of images and labels.

```{r}
#| label: Sources and images used to develop image classification model
#| warning: false

### Sources used
coralNetSourcesTBL <- read_csv(file = "../data/CoralNetSourcesUsed.csv")

### Display as a data table
datatable(coralNetSourcesTBL)
```
